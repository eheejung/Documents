...
- [Altibase 7.1.0.4.9 Patch Notes](#altibase-71049-patch-notes)
  - [New Features](#new-features)
    - [BUG-47821 iloader에서SRID지원을 위해 Geometry 타입 처리를 WKB -> EWKB 포맷으로 변경해야 합니다.](#bug-47821iloader에서 EWKB 형식을 지원합니다. )
