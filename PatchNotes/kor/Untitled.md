...
| POWER8(LE) Red Hat Enterprise Linux 7.2 이상                 |          ●          |                ●                | - GNU glibc 2.12 이상<br />- Altibase 7.1.0.0.8 이상<br />- altimon 은 Altibase 7.1.0.3.6 이상에서 지원<br />- jdbcAdapter는 Altibase 7.1.0.3.6 이상 지원 |
